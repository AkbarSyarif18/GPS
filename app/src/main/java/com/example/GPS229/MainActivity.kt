        ...
        when(requestCode)
        {
            REQUEST_CODE->{
                if (grantResults.size>0){
                    ...
                    Toast.makeText(this@MainActivity,"Permission Gramted", Toast.LENGTH_SHORT).show()
                }else{
    ...
    private fun buildLocationCallBack() {
      locationCallback = object :LocationCallback(){
          override fun onLocationResult(p0: LocationResult?){
              ...
              T_location.text=location.latitude.toString()+"/"+location.longitude.toString()
          }
